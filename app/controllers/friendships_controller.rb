class FriendshipsController < ApplicationController
	...
	def create
		...
		respond_to do |format|
			format.html {redirect_to users_path, notice: "Friendship Created my dude"}
		end
	end
	...
	def destroy
		@friendship.destroy
		respond_to do |format|
			format.html {redirect_to users_path, notice: "Friendship Deleted their done in this town"}
		end
	end
